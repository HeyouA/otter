<h1>最新更新2024年08月02日</h1>
<li><strong>按目标库主键索引Load数据功能</strong>：otter默认使用源表主键索引load数据,在分表合并成一张表时会存在问题,做了改造,支持按照目标端主键索引load数据</li>

<h1>最新更新2024年06月11日</h1>
<li><strong>分库分表特性</strong>：otter不支持分表的场景,增加分库分表功能</li>
